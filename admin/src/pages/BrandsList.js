...
const BrandsList = () => {
  ...
  // useEffect(()=>{
  //    axios.get('http://localhost:5000/admin/brands').then((data)=> setRows(data))
  // })
    ...
    const StyledTableCell = styled(TableCell)(({ theme }) => ({
      ...
      function createData(brandId, brandName, mobile, email, description, socialLinks) {
        return { brandId, brandName, mobile, email, description, socialLinks };
      }
