...
const InfluencersList = () => {
  ...
  // useEffect(()=>{
  //    axios.get('http://localhost:5000/admin/influencers').then((data)=> setRows(data))
  // })
    ...
    const StyledTableCell = styled(TableCell)(({ theme }) => ({
      ...
      function createData(influencerId, brandName, mobile, emial, description, socialLinks) {
        return { influencerId, brandName, mobile, emial, description, socialLinks };
      }
  ...
  return (
   ...
   <TableContainer component={Paper}>
      <Table sx={{ minWidth: 700 }} aria-label="customized table">
        <TableHead>
          <TableRow>
            <StyledTableCell>Influencer ID</StyledTableCell>
            <StyledTableCell align="right">Brand Name</StyledTableCell>
            <StyledTableCell align="right">Mobile</StyledTableCell>
            <StyledTableCell align="right">Email</StyledTableCell>
            <StyledTableCell align="right">Description</StyledTableCell>
            <StyledTableCell align="right">Social Links</StyledTableCell>
        ...
        <TableBody>
          {rows && rows.map((row) => (
            <StyledTableRow key={row.name}>
              ...
              <StyledTableCell align="right">{row.socialLinks}</StyledTableCell>
